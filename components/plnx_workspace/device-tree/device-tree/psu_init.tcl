...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0024 0xFE7FEDEF 0x7E4E2C62
		# : UPDATE FB_DIV
    ...
    mask_write 0XFD1A0020 0x00717F00 0x00013C00
		# : BY PASS PLL
		# Register : APLL_CTRL @ 0XFD1A0020</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0090 0x01003F07 0x01000400
    ...
    mask_write 0XFF5E00A4 0x01003F07 0x01000F00
    ...
    mask_write 0XFD1A00B4 0x01003F07 0x01000400
    ...
    mask_write 0XFD1A0084 0x07003F07 0x07000303
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070064 0x0FFF83FF 0x0061808C
    ...
    mask_write 0XFD0700DC 0xFFFFFFFF 0x03140301
    ...
    mask_write 0XFD0700E0 0xFFFFFFFF 0x00100000
    ...
    mask_write 0XFD070100 0x7F3F7F3F 0x0D0C1A0E
    ...
    mask_write 0XFD070104 0x001F1F7F 0x00030314
    ...
    mask_write 0XFD070108 0x3F3F3F3F 0x0606060B
    ...
    mask_write 0XFD070120 0x7F7F7F7F 0x04040B06
    ...
    mask_write 0XFD07012C 0x7F1F031F 0x0E05010E
    ...
    mask_write 0XFD070184 0x3FFFFFFF 0x0201312D
    ...
    mask_write 0XFD070190 0x1FBFBF3F 0x04888208
    ...
    mask_write 0XFD0701B4 0x00003F3F 0x00000606
    ...
    mask_write 0XFD080018 0xFFFFFFFF 0x00F0BF18
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x051C0C06
    ...
    mask_write 0XFD080114 0xFFFFFFFF 0x28180008
    ...
    mask_write 0XFD080120 0xFFFFFFFF 0x01182B05
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00280C06
    ...
    mask_write 0XFD080128 0xFFFFFFFF 0x00000B0C
    ...
    mask_write 0XFD080180 0xFFFFFFFF 0x00000214
    ...
    mask_write 0XFD080680 0xFFFFFFFF 0x008A0A58
...
set psu_mio_init_data {
    ...
    mask_write 0XFF1800D0 0x000000FE 0x00000040
    ...
    mask_write 0XFF1800D4 0x000000FE 0x00000040
    ...
    mask_write 0XFF180204 0x00FFE03F 0x00000000
    ...
    mask_write 0XFF180208 0x003FC130 0x00000020
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00004000
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00004000
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xBFFF4000
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xBFFF0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5US DELAY
...
set psu_resetout_init_data {
    ...
    mask_write 0XFD480094 0x00007E00 0x00004600
...
mwr -force  0xFD080018 0x00F016D0
...
mwr -force  0xFD080018 0x00F0D9D0
