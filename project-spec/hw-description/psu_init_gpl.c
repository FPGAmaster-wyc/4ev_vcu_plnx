...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_CPU_R5_CTRL_DIVISOR0                            0x4
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0090, 0x01003F07U ,0x01000400U)
    */
	PSU_Mask_Write(CRL_APB_CPU_R5_CTRL_OFFSET, 0x01003F07U, 0x01000400U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PCAP_CTRL_DIVISOR0                              0xf
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00A4, 0x01003F07U ,0x01000F00U)
    */
	PSU_Mask_Write(CRL_APB_PCAP_CTRL_OFFSET, 0x01003F07U, 0x01000F00U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRF_APB_PCIE_REF_CTRL_DIVISOR0                          0x4

    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFD1A00B4, 0x01003F07U ,0x01000400U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRF_APB_GPU_REF_CTRL_DIVISOR0                           0x3
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFD1A0084, 0x07003F07U ,0x07000303U)
    */
	PSU_Mask_Write(CRF_APB_GPU_REF_CTRL_OFFSET,
		0x07003F07U, 0x07000303U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * d. Unit: Clocks.
    *  PSU_DDRC_RFSHTMG_T_RFC_MIN                                  0x8c

    * Refresh Timing Register
    * (OFFSET, MASK, VALUE)      (0XFD070064, 0x0FFF83FFU ,0x0061808CU)
    */
	PSU_Mask_Write(DDRC_RFSHTMG_OFFSET, 0x0FFF83FFU, 0x0061808CU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0700DC, 0xFFFFFFFFU ,0x03140301U)
    */
	PSU_Mask_Write(DDRC_INIT3_OFFSET, 0xFFFFFFFFU, 0x03140301U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0700E0, 0xFFFFFFFFU ,0x00100000U)
    */
	PSU_Mask_Write(DDRC_INIT4_OFFSET, 0xFFFFFFFFU, 0x00100000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070100, 0x7F3F7F3FU ,0x0D0C1A0EU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG0_OFFSET, 0x7F3F7F3FU, 0x0D0C1A0EU);
/*##################################################################### */
    ...
    * r value. Unit: Clocks.
    *  PSU_DDRC_DRAMTMG1_T_RC                                      0x14

    * SDRAM Timing Register 1
    * (OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x00030314U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG1_OFFSET, 0x001F1F7FU, 0x00030314U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070108, 0x3F3F3F3FU ,0x0606060BU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG2_OFFSET, 0x3F3F3F3FU, 0x0606060BU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070120, 0x7F7F7F7FU ,0x04040B06U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG8_OFFSET, 0x7F7F7F7FU, 0x04040B06U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD07012C, 0x7F1F031FU ,0x0E05010EU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG11_OFFSET, 0x7F1F031FU, 0x0E05010EU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * /LPDDR4 devices.
    *  PSU_DDRC_ZQCTL1_T_ZQ_SHORT_INTERVAL_X1024                   0x1312d

    * ZQ Control Register 1
    * (OFFSET, MASK, VALUE)      (0XFD070184, 0x3FFFFFFFU ,0x0201312DU)
    */
	PSU_Mask_Write(DDRC_ZQCTL1_OFFSET, 0x3FFFFFFFU, 0x0201312DU);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070190, 0x1FBFBF3FU ,0x04888208U)
    */
	PSU_Mask_Write(DDRC_DFITMG0_OFFSET, 0x1FBFBF3FU, 0x04888208U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0701B4, 0x00003F3FU ,0x00000606U)
    */
	PSU_Mask_Write(DDRC_DFITMG2_OFFSET, 0x00003F3FU, 0x00000606U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Refresh Period
    *  PSU_DDR_PHY_PGCR2_TREFPRD                                   0xbf18

    * PHY General Configuration Register 2
    * (OFFSET, MASK, VALUE)      (0XFD080018, 0xFFFFFFFFU ,0x00F0BF18U)
    */
	PSU_Mask_Write(DDR_PHY_PGCR2_OFFSET, 0xFFFFFFFFU, 0x00F0BF18U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080110, 0xFFFFFFFFU ,0x051C0C06U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR0_OFFSET, 0xFFFFFFFFU, 0x051C0C06U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080114, 0xFFFFFFFFU ,0x28180008U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR1_OFFSET, 0xFFFFFFFFU, 0x28180008U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080120, 0xFFFFFFFFU ,0x01182B05U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR4_OFFSET, 0xFFFFFFFFU, 0x01182B05U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080124, 0xFFFFFFFFU ,0x00280C06U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR5_OFFSET, 0xFFFFFFFFU, 0x00280C06U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080128, 0xFFFFFFFFU ,0x00000B0CU)
    */
	PSU_Mask_Write(DDR_PHY_DTPR6_OFFSET, 0xFFFFFFFFU, 0x00000B0CU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080180, 0xFFFFFFFFU ,0x00000214U)
    */
	PSU_Mask_Write(DDR_PHY_MR0_OFFSET, 0xFFFFFFFFU, 0x00000214U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_ZQCR_PGWAIT_FRQA                                0x10
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080680, 0xFFFFFFFFU ,0x008A0A58U)
    */
	PSU_Mask_Write(DDR_PHY_ZQCR_OFFSET, 0xFFFFFFFFU, 0x008A0A58U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * put, ua1_txd- (UART transmitter serial output) 7= trace, Output, trace_c
    * lk- (Trace Port Clock)
    *  PSU_IOU_SLCR_MIO_PIN_52_L3_SEL                              2

    * Configures MIO Pin 52 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800D0, 0x000000FEU ,0x00000040U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_52_OFFSET, 0x000000FEU, 0x00000040U);
/*##################################################################### */
    ...
    * receiver serial input) 7= trace, Output, trace_ctl- (Trace Port Control
    * Signal)
    *  PSU_IOU_SLCR_MIO_PIN_53_L3_SEL                              2

    * Configures MIO Pin 53 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF1800D4, 0x000000FEU ,0x00000040U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_53_OFFSET, 0x000000FEU, 0x00000040U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0x00FFE03FU ,0x00000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0x00FFE03FU, 0x00000000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0x003FC130U ,0x00000020U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0x003FC130U, 0x00000020U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_GPIO_DIRM_1_DIRECTION_1                                 0x4000

    * Direction mode (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0244, 0x03FFFFFFU ,0x00004000U)
    */
	PSU_Mask_Write(GPIO_DIRM_1_OFFSET, 0x03FFFFFFU, 0x00004000U);
/*##################################################################### */
    ...
    *  PSU_GPIO_OEN_1_OP_ENABLE_1                                  0x4000

    * Output enable (GPIO Bank1, MIO)
    * (OFFSET, MASK, VALUE)      (0XFF0A0248, 0x03FFFFFFU ,0x00004000U)
    */
	PSU_Mask_Write(GPIO_OEN_1_OFFSET, 0x03FFFFFFU, 0x00004000U);
/*##################################################################### */
    ...
    *  PSU_GPIO_MASK_DATA_1_LSW_MASK_1_LSW                         0xbfff

    * Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
    *  PSU_GPIO_MASK_DATA_1_LSW_DATA_1_LSW                         0x4000

    * Maskable Output Data (GPIO Bank1, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0008, 0xFFFFFFFFU ,0xBFFF4000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_1_LSW_OFFSET,
		0xFFFFFFFFU, 0xBFFF4000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Maskable Output Data (GPIO Bank1, MIO, Lower 16bits)
    * (OFFSET, MASK, VALUE)      (0XFF0A0008, 0xFFFFFFFFU ,0xBFFF0000U)
    */
	PSU_Mask_Write(GPIO_MASK_DATA_1_LSW_OFFSET,
		0xFFFFFFFFU, 0xBFFF0000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(0,0,0,0,0,0,1,0);
...
/*##################################################################### */
    ...
    *  PSU_PCIE_ATTRIB_ATTR_37_ATTR_LINK_CAP_MAX_LINK_SPEED        0x1
    ...
    * ATTR_37
    * (OFFSET, MASK, VALUE)      (0XFD480094, 0x00007E00U ,0x00004600U)
    */
	PSU_Mask_Write(PCIE_ATTRIB_ATTR_37_OFFSET, 0x00007E00U, 0x00004600U);
/*##################################################################### */
